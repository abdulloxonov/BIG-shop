<template>
      ...
      <div class="carousel-wrapper">
        <swiper :keyboard="keyboardConfig" slidesPerView="3" spaceBetween={20}>
          <swiper-slide v-for="(item, index) in visibleItems" :key="index">
            ...
            <p>25 октября</p>
       <h3>Тест Skoda Karoq Scout - городской карлик или настоящий скаут</h3>
          </swiper-slide>
        </swiper>
      </div>
  ...
  import famliy1 from '../Group4246/img/Rectangle 575 (1).png'
 import famliy2 from '../Group4246/img/Rectangle 575 (1).png'
 import famliy3 from '../Group4246/img/Rectangle 575 (1).png'
