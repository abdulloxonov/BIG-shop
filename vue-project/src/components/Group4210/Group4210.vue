<template>
        ...
        <swiper :keyboard="keyboardConfig" slidesPerView="3" spaceBetween={20}>
          <swiper-slide v-for="(item, index) in visibleItems" :key="index">
            ...
            <div class="card-content">
              ...
              <button class="view-btn">Узнать больше</button>
            </div>
          </swiper-slide>
        </swiper>
      </div>
  ...
  import img1 from '../Group4210/img/img1.png'
  import img2 from '../Group4210/img/img2.png'
  import img3 from '../Group4210/img/img3.png'
